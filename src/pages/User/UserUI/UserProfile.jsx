...
const handleSubmit = (e) => {
  ...
  const ImageUploadBox = ({ label, preview, type }) => (
    <div className="space-y-2">
      <label className={`block text-sm font-semibold ${scheme.text}`}>{label}</label>
      <div className="relative group">
        <div className={`relative ${type === 'avatar' ? 'w-32 h-32 rounded-full mx-auto' : 'w-full h-40 rounded-xl'} overflow-hidden border-2 ${
          ...
          {preview ? (
            ...
            <div className="w-full h-full flex flex-col items-center justify-center">
              <Camera className={`w-10 h-10 mb-2 ${darkMode ? 'text-gray-500' : 'text-gray-400'}`} />
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className={`relative w-full max-w-3xl max-h-[90vh] rounded-2xl shadow-2xl overflow-hidden ${scheme.card}`}>
        {/* Header */}
        <div className={`sticky top-0 z-20 flex items-center justify-between px-6 py-4 border-b ${scheme.border} ${scheme.card}`}>
...
>   <div className="space-y-6">
            ...
            <div className={`p-6 rounded-xl ${darkMode ? 'bg-gray-700/30' : 'bg-gray-50'}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <ImageUploadBox label="Profile Picture" preview={previewAvatar} type="avatar" />
                <ImageUploadBox label="Cover Photo" preview={previewCover} type="cover" />
              </div>
            </div>

            {/* Personal Information */}
            <div className={`p-6 rounded-xl ${darkMode ? 'bg-gray-700/30' : 'bg-gray-50'}`}>
              <h4 className={`text-lg font-bold mb-4 ${scheme.text}`}>Personal Information</h4>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Juan"
                    required
                    className={`w-full px-4 py-2.5 rounded-lg border ${darkMode ? 'bg-gray-700 border-gray-600 text-white placeholder-gray-500' : 'bg-white border-gray-300 text-gray-900 placeholder-gray-400'} focus:outline-none focus:ring-2 focus:ring-green-500`}
                  />
                </div>
                <div>
                  <label className={`block text-sm font-semibold mb-2 ${scheme.text}`}>Middle Name</label>
                  <input
                    type="text"
                    name="middleName"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  <label className={`block text-sm font-semibold mb-2 ${scheme.text}`}>Phone</label>
                  <input
                    type="tel"
                    name="phoneNumber"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                  <label className={`block text-sm font-semibold mb-2 ${scheme.text}`}>Birthday</label>
                  <input
                    type="date"
                    name="birthday"
              ...
              {/* Account Type */}
              <div className="mb-4">
                <label className={`block text-sm font-semibold mb-2 ${scheme.text}`}>Account Type</label>
        ...
        {/* Footer */}
        <div className={`sticky bottom-0 flex gap-3 px-6 py-4 border-t ${scheme.border} ${scheme.card}`}>
          <button
            type="button"
            onClick={onClose}
            className={`flex-1 px-6 py-3 rounded-lg font-semibold transition ${darkMode ? 'bg-gray-700 text-white hover:bg-gray-600' : 'bg-gray-200 text-gray-900 hover:bg-gray-300'}`}
          >
            Cancel
          </button>
          <button
...
const [formData, setFormData] = useState({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className={`relative w-full max-w-2xl max-h-[90vh] rounded-2xl shadow-2xl overflow-hidden ${scheme.card}`}>
        {/* Header */}
        <div className={`sticky top-0 z-20 flex items-center justify-between px-6 py-4 border-b ${scheme.border} ${scheme.card}`}>
...
>
          <div className="space-y-6">
            {/* Images Section */}
            <div className={`p-6 rounded-xl ${darkMode ? 'bg-gray-700/30' : 'bg-gray-50'}`}>
              <h4 className={`text-lg font-bold mb-4 ${scheme.text}`}>Images (Max 10)</h4>
              
              {/* Image Grid */}
              <div className="grid grid-cols-2 gap-4 mb-4">
                {previews.map((img, index) => (
                  <div key={index} className="relative group">
                    <img src={img} alt={`Preview ${index + 1}`} className="w-full h-40 object-cover rounded-lg" />
                    <button
                      type="button"
                ...
                {/* Upload Button */}
                {previews.length < 4 && (
                  <label className={`relative flex flex-col items-center justify-center h-40 border-2 border-dashed rounded-lg cursor-pointer transition-colors ${
                    darkMode 
            ...
            {/* Post Details */}
            <div className={`p-6 rounded-xl ${darkMode ? 'bg-gray-700/30' : 'bg-gray-50'}`}>
              <h4 className={`text-lg font-bold mb-4 ${scheme.text}`}>Post Details</h4>
              
              {/* Title */}
              <div className="mb-4">
                <label className={`block text-sm font-semibold mb-2 ${scheme.text}`}>Title *</label>
                <input
                  type="text"
                  name="title"
              ...
              <div className="grid grid-cols-3 gap-4 mb-4">
                <div>
                  <label className={`block text-sm font-semibold mb-2 ${scheme.text}`}>Type</label>
                  <input
                    type="text"
                    name="type"
                    value={formData.type}
                ...
                <div>
                  <label className={`block text-sm font-semibold mb-2 ${scheme.text}`}>Age</label>
                  <input
                    type="text"
                    name="age"
                    value={formData.age}
                ...
                <div>
                  <label className={`block text-sm font-semibold mb-2 ${scheme.text}`}>Sex</label>
                  <select
                    name="sex"
                    value={formData.sex}
                    onChange={handleInputChange}
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  <label className={`block text-sm font-semibold mb-2 ${scheme.text}`}>Price *</label>
                  <input
                    type="text"
                    name="price"
...
>
  ...
  <option value="discontinued">Discontinued</option>
              ...
              {/* Description */}
              <div>
                <label className={`block text-sm font-semibold mb-2 ${scheme.text}`}>Description</label>
                <textarea
                  name="description"
        ...
        {!showPreview ? (
          <div className="p-6">
            <div className="text-center mb-6">
              ...
              <p className={`text-sm mt-4 ${scheme.muted}`}>Scan this code with your phone camera to view profile</p>
            </div>
      ...
      {profileData.accountType && (
        <span
          className={`text-xs px-2 py-1 rounded-full flex-shrink-0 font-medium ${
            getUserTypeBadge(profileData.accountType, darkMode).className
          }`}
        >
          {getUserTypeBadge(profileData.accountType, darkMode).label}
        </span>
      )}
    </div>

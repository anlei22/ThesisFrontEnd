...
const Mainboard = () => {
  ...
  const { data: newsFeedData, loading: newsFeedLoading } = useApiConnection("news-feed/GetAllNewsFeed");
          ...
          <div>
            ...
            <div className="relative">
              ...
              {showCategoryDropdown && (
                <div
                  className={`absolute top-full left-0 w-full mt-1 ${darkMode ? "bg-gray-700" : "bg-white"
                ...
                >
                  {categories.map((category) => (
                    <button
                      ...
                      className={`w-full flex items-center space-x-3 p-3 text-left hover:${darkMode ? "bg-gray-600" : "bg-gray-50"
  ...
  return (
    <AuthProvider>
      <div
        className={`min-h-screen w-full transition-colors duration-300 ${darkMode ? "bg-gray-900" : "bg-green-50"
          }`}
      >
        <Navbar
          activeTab={activeTab}
        ...
        <div className="w-full">
          {activeTab === "home" ? (
            <>
              ...
              <div
                className={`hidden lg:flex gap-5 px-6 lg:px-12 ${!viewingUserProfile ? "h-[680px] overflow-hidden" : ""
                  }`}
              >
                      ...
                      >
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center gap-2">
                            <div
                              className={`p-2 rounded-lg ${darkMode ? "bg-green-600" : "bg-green-100"
                                }`}
                            >
                              <TrendingUp
                                className={`w-5 h-5 ${darkMode ? "text-white" : "text-green-600"
                                  }`}
                              />
                            </div>
                            <h3
                        ...
                        <div className="p-4 space-y-3">
                          {newsFeedLoading ? (
                            ...
                            <div className={`text-center py-8 ${darkMode ? "text-gray-400" : "text-gray-500"}`}>
                              <TrendingUp className={`w-12 h-12 mx-auto mb-2 ${darkMode ? "text-gray-600" : "text-gray-300"}`} />

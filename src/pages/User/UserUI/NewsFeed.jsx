 ...
 const loadSampleData = () => {
  const samplePosts = [
    ...
    },
    {
      ...
      content: "Kittens for adoption! These playful little furballs are looking for a loving family. 🐱💕 #AdoptDontShop #Kittens",
      animalInfo: {
        type: "Cat",
        title: "Adorable kittens looking for a home",
        description: "We have 4 kittens, 2 months old, litter trained, healthy, and full of energy!",
        breed: "Mixed",
        age: "2 months old",
        sex: "Male & Female",
        price: "Free",
      ...
      images: [
        "https://images.unsplash.com/photo-1592194996308-7b43878e84a6?w=500&h=400&fit=crop",
         "https://images.unsplash.com/photo-1583337130417-3346a1be7dee?w=500&h=400&fit=crop",
                 "https://images.unsplash.com/photo-1592194996308-7b43878e84a6?w=500&h=400&fit=crop",
                         "https://images.unsplash.com/photo-1592194996308-7b43878e84a6?w=500&h=400&fit=crop",
                                 "https://images.unsplash.com/photo-1592194996308-7b43878e84a6?w=500&h=400&fit=crop",
...
return (  
  <div className="w-full h-[680px] py-4 sm:py-6 flex justify-center">
    <div className="w-full max-w-2xl px-2 sm:px-0 flex flex-col h-full">
      ...
      {/* Create Post Card (fixed, not scrollable) */}
      <div
        ...
        {posts.length > 0 ? (
          posts.map((post) => (
            ...
            >
              ...
              {/* Stats */}
              <div
                className={`px-3 sm:px-10 py-2 sm:py-3 border-t flex items-center justify-between ${
              ...
              <div
                className={`px-2 sm:px-6 py-2 sm:py-3 border-t flex items-center justify-around ${
                  darkMode ? 'border-gray-700' : 'border-gray-100'
                }`}
              >
                {isAuthenticated && (
          ...
          >
            ...
            <p className="text-sm mb-4">
              No animal posts have been shared yet. Be the first to share an
              animal for sale or adoption!
            </p>
            <button
